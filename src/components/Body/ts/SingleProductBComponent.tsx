      ...
      <div className="wrapper__singleproduct">
        <div className="singleproduct__images">
          <img
            ...
            alt={product?.title}
            className="img__singleproduct"
          />
          <img
            src={product?.img.down}
            alt={product?.title}
            className="img__singleproduct"
          />
          <img
            src={product?.img.aside}
            alt={product?.title}
            className="img__singleproduct"
          />
          <img
        ...
        <div className="singleproduct__info">
          ...
          <div className="sizesdiv__singleproduct">
            ...
            <div className="sizeselector__div">
              {product?.sizes.map((size) => {
                return (
                  <div key={size} className="divsize__singleproduct">
                    EU {size}
                  </div>
                );
              })}
          ...
          <div className="buttonsdiv__singleproduct">
            <button
              className="button__singleproduct addtocart"
              onClick={() => dispatch({ type: "ADD_ITEM", payload: item })}
            >
              Añadir a la cesta
            </button>
            <button className="button__singleproduct">
              Favorito{" "}
